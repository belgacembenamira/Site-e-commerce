      ...
      <div>
        <div className="container">
          <div className="row align-items-start mt-3 mx-3 my-3 d-flex justify-content-center">
            <div className="col ">
              <h1> Welcom to cathogorie Homme</h1>
            ...
            <div className="col">
              <img
                className=""
                src={
                  "https://www.masculin.com/wp-content/uploads/sites/2/2021/10/marques-de-vetements-homme-1500x1028.jpg.webp"
                }
                alt="My-shop"
                width="100%"
                height="100%"
          ...
          <div className="col-4">
            <div className="zoom-in">
              <Card style={{ width: "18rem" }}>
                ...
                <Card.Body>
                  <Card.Title>produit 67</Card.Title>
                  <Card.Text>
                    <del>25$</del>{" "}
                    <ins>
                      {" "}
          ...
          <div className="col-4">
            <div className="">
              <Card style={{ width: "18rem" }}>
                ...
                <Card.Body>
                  <Card.Title>produit 69</Card.Title>
                  <Card.Text>
                    <del>25$</del>{" "}
                    <ins>
                      {" "}
          ...
          <div className="col-4 ">
            <div className="">
              <Card style={{ width: "18rem" }}>
                ...
                <Card.Body>
                  <Card.Title>produit 70</Card.Title>
                  <Card.Text>
                    <del>25$</del>{" "}
                    <ins>
                      {" "}
          ...
          <div className="col-4">
            <div className="mt-3">
              <Card style={{ width: "18rem" }}>
                <Card.Img
                  variant="top"
                  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcShC8-ZcvZ7fl_91quldEChgRGVbM-wCutIZA&usqp=CAU"
                />

                <Card.Body>
                  <Card.Title>produit 15</Card.Title>
                  <Card.Text>
                    <del>35$</del>
                    <ins>
                      {" "}
          ...
          <div className="col-4">
            <div className="mt-3">
              <Card style={{ width: "18rem" }}>
                <Card.Img
                  variant="top"
                  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ-wFVbMkuCTCv_vVqNepXwZeNZJaCWdXngsw&usqp=CAU"
                />

                <Card.Body>
                  <Card.Title>produit 255</Card.Title>
                  <Card.Text>
                    <del>35$</del>
                    <ins>
                      {" "}
          ...
          <div className="col-4">
            <div className="mt-3">
              <Card style={{ width: "18rem" }}>
                <Card.Img
                  variant="top"
                  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRobJuuS9r_qVU9Y_OgVQ_wI6SNlhCzGdDxXA&usqp=CAU"
                />

                <Card.Body>
                  <Card.Title>produit 60</Card.Title>
                  <Card.Text>
                    <del>35$</del> <strong>30$ </strong>
                  </Card.Text>
                  <Button variant="light">
                    <Link to="/reservation"> acheter</Link>
                  </Button>
